...
df = pd.read_csv('Laptime CSV Data/2023 Season/MonacoGP/2023 MonacoGP LapTimes.csv')
df_qual = pd.read_csv('Laptime CSV Data/2023 Season/MonacoGP/2023 MonacoGP Quali.csv')
